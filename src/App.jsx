    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">vishwa</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">vishwa</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Your day, your smile,your story  💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Krutaksh 💖</h2>
          <p className="final-subtitle">once again,happy birthday vishwa ✨</p>
        </section>
      </div>
